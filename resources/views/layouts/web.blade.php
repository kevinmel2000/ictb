...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="slider" class="slider-element slider-parallax full-screen dark" style="overflow: hidden; background: url('{{ asset("images/home2.jpg") }}') no-repeat center center;background-size: cover;">
			<div class="slider-parallax-inner">
				<div class="container clearfix vertical-middle" style="z-index: 3;">
					<div class="heading-block title-center nobottomborder">
						<h1>3<sup>rd</sup> International Conference on Tropical Biology</h1>
						<h3>"Conservation, Enhancement and Sustainable Use of Indigenous Tropical Flora and Fauna"</h3>

						<h5>20 - 21 September 2018, SEAMEO BIOTROP Convention Hall, Jl. Raya Tajur Km. 6, Bogor, Indonesia</h5>
					</div>
					...
					<div class="center topmargin-lg">
						<a href="#" class="button button-3d button-purple button-rounded button-xlarge">Register Now</a>
		...
		<div class="row bottommargin-lg common-height">
			<div class="col-lg-4 dark col-padding ohidden" style="background-color: rgb(26, 188, 156); height: 356.8px;">
				<div>
					<h3 class="uppercase" style="font-weight: 600;">Background</h3>
						...
						<div class="col_one_third">
							<div class="widget clearfix">
								...
								<div style="background: url('images/world-map.png') no-repeat center center; background-size: 100%;">
									...
									<abbr title="Email Address"><strong>Email:</strong></abbr> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="e881868e87a88b89869e899bc68b8785">[email&#160;protected]</a>
								</div>
							</div>
						</div>
						<div class="col_one_third">
			...
			<div id="copyrights">
				<div class="container clearfix">
					...
					<div class="col_half col_last tright">
						...
						<div class="clear"></div>
						<i class="icon-envelope2"></i> <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="640d0a020b2407050a1205174a070b09">[email&#160;protected]</a> <span class="middot">&middot;</span> <i class="icon-headphones"></i> +91-11-6541-6369 <span class="middot">&middot;</span> <i class="icon-skype2"></i> CanvasOnSkype
					</div>
				</div>
			</div>
		</footer>
