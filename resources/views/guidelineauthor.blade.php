        ...
        <div class="container clearfix">
          ...
          <table class="table table-striped">
            ...
            <tr>
                ...
                <td><strong>1 – 1</strong><strong>9</strong><strong> Juni 2018</strong></td>
            </tr>
            <tr>
                <td>Announcement of accepted abstracts for oral and poster    presentations</td>
                <td><strong>2</strong><strong>0</strong> June 2018</td>
            </tr>
            <tr>
...
<p></p>
        <div class="fancy-title title-double-border">
            <h4><span>Full Paper Preparation</span></h4>
        </div>

        <p>
           <ol style="margin-left:30px">
              <li>Full papers must be submitted for both oral and poster presentation if authors would like them to be included  in the Conference Proceedings.</li>
              <li>The full paper must be written in English using  Microsoft Word format in Times New Roman, 11 pt font size, single spaced, with  indented paragraphs.</li>
              <li>The full paper should not exceed 20 (twenty) A4  pages, including all tables, graphics, references and acknowledgement.</li>
              <li>The full paper should contain the following  sections:</li>
              <ul style="margin-left:30px">
                  <li>Title</li>
    ...
    <ul style="margin-left:30px">
      <li>Authors will be provided by username, password,  and registration number when completed the online registration process and have  access to edit their abstract until the deadline for abstract submission on 30 April 2018 at 23:59 GMT+7.</li>
      ...
      <li>When the file exceeds 300 KB (because of  graphics) and it is necessary to post the graphics into the full paper, please  contact the Organizing Committee (bio-ictb@biotrop.org). Other means to upload  your full paper will be provided.</li>
      <li>Deadline for submission of full paper and  payment of registration fee is on 10  August 2018 at 23:59  GMT+7.</li>
  </ul>
...
<li>Poster must also show the Registration number of  the poster, the Conference name and Theme, Conference Organizer (SEAMEO  BIOTROP), and place and date of conference (SEAMEO BIOTROP, Bogor-Indonesia, 27-28 September 2018).</li>
...
<ul style="margin-left: 30px">
  ...
  <li>Posters must be placed on the designated area on  27 September 2018 before the opening ceremony.</li>
